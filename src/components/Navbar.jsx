              ...
              <div className="cat-dd-list">
                {Object.entries(groupedCats).map(([groupKey, cats]) => (
                  <div key={groupKey}>
                    ...
                    {cats.map(c => (
                      <div key={c.slug} className="cat-dd-item" onClick={() => { setCatDdOpen(false); navigate('/category/'+c.slug); }}>
        ...
        <div className="nav-search-wrap">
          ...
          {searchOpen && suggestions.length > 0 && (
            <div className="search-sugg">
              {suggestions.map(c => (
                <div key={c.slug} className="sugg-item" onClick={() => { setSearchOpen(false); navigate('/category/'+c.slug); }}>
