  ...
  return (
    <div id="pspSection" style={{
      ...
      <style>{`
        ...
        .psp-products { display:grid; grid-template-columns:repeat(3,1fr); gap:.65rem; }
          ...
          <div className="psp-products">
            {catProducts.map((p, i) => (
              ...
              >
                ...
                <img src={p.img} alt={p.name} style={{ width: '100%', height: '120px', objectFit: 'contain', display: 'block', pointerEvents: 'none', padding: '8px', background: '#f4f0ff' }} />
