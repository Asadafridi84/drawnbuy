  ...
  return (
    <div id="pspSection" style={{
      ...
      <style>{`
        ...
        .psp-products { display:grid; grid-template-columns:repeat(5,1fr); gap:.4rem; }
          ...
          <div className="psp-products">
            {catProducts.map((p, i) => (
              ...
              >
                ...
                <img src={p.img} alt={p.name} style={{ width: '100%', height: '30px', objectFit: 'contain', display: 'block', pointerEvents: 'none', padding: '2px', background: '#f4f0ff' }} />
