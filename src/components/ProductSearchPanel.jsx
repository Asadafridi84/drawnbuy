  ...
  return (
    <div id="pspSection" style={{
      ...
      <style>{`
        ...
        .psp-products { display:grid; grid-template-columns:repeat(4,1fr); gap:.5rem; }
          ...
          <div className="psp-products">
            {catProducts.map((p, i) => (
              ...
              >
                ...
                <img src={p.img} alt={p.name} style={{ width: '100%', height: '80px', objectFit: 'contain', display: 'block', pointerEvents: 'none', padding: '6px', background: '#f4f0ff' }} />
