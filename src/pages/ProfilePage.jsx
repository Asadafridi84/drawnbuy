...
export default function ProfilePage() {
  ...
  const addToWishlist = (prod) => {
    if (wishlist.find(p=>p.id===prod.id)) { showToast('Already in wishlist'); return; }
    setWishlist(p=>[...p,prod]);
  ...
  return (
    <div style={{minHeight:'100vh',background:'#f4f0ff',padding:'1.5rem 1rem'}}>
      ...
      <div className="pw">
        ...
        {tab==='whiteboard' && (
          <div>
            <div style={{display:'grid',gridTemplateColumns:'220px 1fr 260px',gap:'1rem',alignItems:'start',marginBottom:'1.25rem'}}>
              <div>
            ...
            <div className="pc">
              ...
              {wishlist.length===0 ? (
                <div style={{textAlign:'center',padding:'2rem',color:'#9ca3af'}}>
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#ddd6fe" strokeWidth="1.5" style={{marginBottom:'1rem'}}><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
