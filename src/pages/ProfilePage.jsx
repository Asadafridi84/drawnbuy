...
const CSS = `.pw{display:grid;grid-template-columns:1fr;gap:0;max-width:1000px;margin:0 auto}.cover{position:relative;height:220px;background:linear-gradient(135deg,#7c3aed,#4c1d95,#1e1b4b);border-radius:16px 16px 0 0;overflow:hidden}.cover-img{width:100%;height:100%;object-fit:cover;opacity:.7}.cover-edit{position:absolute;bottom:12px;right:12px;background:rgba(0,0,0,.5);color:#fff;border:none;border-radius:8px;padding:6px 14px;font-size:.78rem;font-weight:700;cursor:pointer;display:flex;align-items:center;gap:6px}.profile-card{background:#fff;border-radius:0 0 16px 16px;padding:0 2rem 1.5rem;box-shadow:0 4px 24px rgba(124,58,237,.1);position:relative;margin-bottom:1.5rem}.avatar-wrap{position:relative;display:inline-block;margin-top:-48px;margin-bottom:.75rem}.av{width:96px;height:96px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#5b21b6);color:#fff;font-size:2rem;font-weight:800;display:flex;align-items:center;justify-content:center;border:4px solid #fff;box-shadow:0 2px 12px rgba(124,58,237,.3)}.av-upload{position:absolute;bottom:4px;right:4px;width:28px;height:28px;border-radius:50%;background:#7c3aed;color:#fff;border:2px solid #fff;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:.7rem}.live-ring{position:absolute;inset:0;border-radius:50%;border:3px solid #ef4444;animation:pulse 1.5s infinite}@keyframes pulse{0%,100%{opacity:1;transform:scale(1)}50%{opacity:.6;transform:scale(1.05)}}.profile-top{display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:1rem}.profile-info{flex:1}.profile-name{font-size:1.4rem;font-weight:800;color:#1a0a3e;display:flex;align-items:center;gap:.5rem}.verified{color:#7c3aed;font-size:1rem}.live-badge{background:#ef4444;color:#fff;font-size:.65rem;font-weight:800;padding:2px 8px;border-radius:20px;letter-spacing:.05em}.handle{font-size:.82rem;color:#6b7280;margin:.2rem 0 .75rem}.pstats{display:flex;gap:1.5rem;flex-wrap:wrap;margin-bottom:.75rem}.pstat{text-align:center}.pstat-num{font-size:1.1rem;font-weight:800;color:#1a0a3e}.pstat-lbl{font-size:.72rem;color:#9ca3af}.pactions{display:flex;gap:.6rem;flex-wrap:wrap}.btn-pri{background:linear-gradient(90deg,#7c3aed,#5b21b6);color:#fff;border:none;border-radius:10px;padding:.55rem 1.1rem;font-size:.82rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem}.btn-sec{background:#f4f0ff;color:#7c3aed;border:1.5px solid #ede9fe;border-radius:10px;padding:.5rem 1rem;font-size:.82rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem}.btn-live{background:linear-gradient(90deg,#ef4444,#dc2626);color:#fff;border:none;border-radius:10px;padding:.55rem 1.1rem;font-size:.82rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem}.ptabs{display:flex;gap:0;background:#fff;border-radius:12px;padding:.4rem;box-shadow:0 2px 12px rgba(124,58,237,.08);margin-bottom:1.5rem;overflow-x:auto;scrollbar-width:none}.ptabs::-webkit-scrollbar{display:none}.ptab{display:flex;align-items:center;gap:.35rem;padding:.55rem .9rem;border-radius:8px;border:none;background:transparent;color:#6b7280;font-family:inherit;font-size:.82rem;font-weight:600;cursor:pointer;white-space:nowrap;transition:.15s}.ptab:hover{background:#f4f0ff;color:#7c3aed}.ptab.on{background:linear-gradient(90deg,#7c3aed,#5b21b6);color:#fff}.pc{background:#fff;border-radius:16px;padding:1.5rem;box-shadow:0 2px 12px rgba(124,58,237,.08);margin-bottom:1rem}.st{font-size:1rem;font-weight:800;color:#1a0a3e;margin-bottom:.25rem}.ss{font-size:.8rem;color:#6b7280;margin-bottom:1.25rem}.fl{font-size:.8rem;font-weight:700;color:#374151;margin-bottom:.4rem;display:block}.fi{width:100%;border:1.5px solid #e5e7eb;border-radius:10px;padding:.65rem .9rem;font-family:inherit;font-size:.88rem;color:#1a0a3e;outline:none;transition:.15s;box-sizing:border-box}.fi:focus{border-color:#7c3aed;box-shadow:0 0 0 3px rgba(124,58,237,.12)}.fi:disabled{background:#f9fafb;color:#9ca3af}.bp{background:linear-gradient(90deg,#7c3aed,#5b21b6);color:#fff;border:none;border-radius:10px;padding:.65rem 1.4rem;font-family:inherit;font-size:.88rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem;transition:.15s}.bd{background:#fee2e2;color:#b91c1c;border:1.5px solid #fca5a5;border-radius:10px;padding:.55rem 1.1rem;font-family:inherit;font-size:.82rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem}.bg2{background:#f4f0ff;color:#7c3aed;border:1.5px solid #ede9fe;border-radius:10px;padding:.55rem 1.1rem;font-family:inherit;font-size:.82rem;font-weight:700;cursor:pointer;transition:.15s;display:inline-flex;align-items:center;gap:.4rem}.dv{border:none;border-top:1px solid #f3f4f6;margin:1.25rem 0}.fc{display:flex;align-items:center;gap:.9rem;padding:.85rem;border-radius:12px;border:1.5px solid #f3f4f6;background:#fafafa;margin-bottom:.6rem;transition:.15s}.fc:hover{border-color:#ede9fe;background:#f4f0ff}.fa{width:42px;height:42px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#5b21b6);color:#fff;font-size:.88rem;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0}.fn{font-size:.9rem;font-weight:700;color:#1a0a3e}.fe{font-size:.75rem;color:#9ca3af}.ftag{font-size:.68rem;font-weight:700;padding:2px 8px;border-radius:20px}.tfam{background:#dbeafe;color:#1d4ed8}.tfri{background:#d1fae5;color:#065f46}.tinv{background:#fef3c7;color:#92400e}.sd{width:8px;height:8px;border-radius:50%;flex-shrink:0}.son{background:#22c55e}.sof{background:#d1d5db}.sin{background:#fbbf24}.nr{display:flex;align-items:center;justify-content:space-between;padding:.85rem 0;border-bottom:1px solid #f3f4f6}.nl{font-size:.88rem;font-weight:600;color:#1a0a3e}.ns{font-size:.75rem;color:#9ca3af}.tog{position:relative;width:44px;height:24px;cursor:pointer;display:inline-block}.tog input{opacity:0;width:0;height:0}.tsl{position:absolute;inset:0;border-radius:24px;background:#e5e7eb;transition:.2s}.tog input:checked + .tsl{background:#7c3aed}.tsl::before{content:'';position:absolute;width:18px;height:18px;left:3px;top:3px;border-radius:50%;background:#fff;transition:.2s;box-shadow:0 1px 4px rgba(0,0,0,.2)}.tog input:checked + .tsl::before{transform:translateX(20px)}.ok{background:#d1fae5;color:#065f46;border-radius:8px;padding:.5rem .9rem;font-size:.82rem;font-weight:700;display:inline-flex;align-items:center;gap:.4rem}.feed-item{display:flex;gap:.75rem;padding:.85rem 0;border-bottom:1px solid #f3f4f6}.feed-av{width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.82rem;font-weight:800;flex-shrink:0;color:#fff;background:linear-gradient(135deg,#7c3aed,#5b21b6)}.feed-text{font-size:.85rem;color:#374151;line-height:1.5}.feed-time{font-size:.72rem;color:#9ca3af;margin-top:.2rem}.badge-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(100px,1fr));gap:.75rem}.badge-card{background:#f4f0ff;border-radius:12px;padding:.85rem;text-align:center;border:1.5px solid #ede9fe}.badge-icon{font-size:1.5rem;margin-bottom:.35rem}.badge-name{font-size:.72rem;font-weight:700;color:#7c3aed}.badge-desc{font-size:.65rem;color:#9ca3af;margin-top:.15rem}.stat-bar{display:flex;align-items:center;gap:.75rem;margin-bottom:.6rem}.stat-bar-label{font-size:.78rem;color:#374151;width:80px;flex-shrink:0}.stat-bar-track{flex:1;height:8px;background:#f3f4f6;border-radius:20px;overflow:hidden}.stat-bar-fill{height:100%;border-radius:20px;background:linear-gradient(90deg,#7c3aed,#5b21b6)}.stat-bar-val{font-size:.75rem;font-weight:700;color:#7c3aed;width:30px;text-align:right;flex-shrink:0}.ref-box{background:linear-gradient(135deg,#f4f0ff,#ede9fe);border-radius:12px;padding:1.25rem;border:1.5px solid #ddd6fe;text-align:center}.ref-link{font-size:.82rem;font-family:monospace;background:#fff;border:1.5px solid #ede9fe;border-radius:8px;padding:.5rem .9rem;color:#7c3aed;font-weight:700;letter-spacing:.02em}.room-card{display:flex;align-items:center;justify-content:space-between;padding:.85rem;border-radius:12px;border:1.5px solid #f3f4f6;background:#fafafa;margin-bottom:.6rem}.room-name{font-size:.9rem;font-weight:700;color:#1a0a3e}.room-meta{font-size:.75rem;color:#9ca3af}.room-badge{font-size:.65rem;font-weight:700;padding:2px 8px;border-radius:20px}.rb-live{background:#fee2e2;color:#b91c1c}.rb-guest{background:#fef3c7;color:#92400e}.rb-member{background:#d1fae5;color:#065f46}.order-card{display:flex;align-items:center;gap:.9rem;padding:.85rem;border-radius:12px;border:1.5px solid #f3f4f6;margin-bottom:.6rem}.order-img{width:52px;height:52px;border-radius:8px;background:#f4f0ff;display:flex;align-items:center;justify-content:center;font-size:1.2rem;flex-shrink:0}.order-name{font-size:.88rem;font-weight:700;color:#1a0a3e}.order-meta{font-size:.75rem;color:#9ca3af}.order-price{font-size:.95rem;font-weight:800;color:#7c3aed;white-space:nowrap}@media(max-width:768px){.pw{grid-template-columns:1fr}.pactions{gap:.4rem}.pstats{gap:1rem}}`;
