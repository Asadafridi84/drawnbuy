          ...
          <div style={{display:'grid',gridTemplateColumns:'220px 1fr 260px',gap:'1rem',alignItems:'start'}}>
            ...
            <div>
              ...
              <div className="pc">
                ...
                {[['AL','Anna Lindqvist','#7c3aed','Family',true,true],
                  ['ME','Maja Eriksson','#22c55e','Friend',true,true],
                  ['EJ','Erik Johansson','#fbbf24','Family',false,true],
                  ['SB','Sofia Berg','#ef4444','Friend',false,false],
                  ['LH','Lars Holm','#0ea5e9','Friend',true,true]].map(([av,name,bg,tag,online,checked])=>(
                  <div key={name} style={{display:'flex',alignItems:'center',gap:'.6rem',marginBottom:'.6rem'}}>
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      <div style={{fontSize:'.78rem',fontWeight:700,color:'#1a0a3e',whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'}}>{name}</div>
            ...
            <div style={{background:'linear-gradient(135deg,#1e1b4b,#4c1d95)',borderRadius:16,overflow:'hidden',display:'flex',flexDirection:'column',height:'100%',minHeight:500}}>
              <div style={{padding:'1rem',display:'flex',alignItems:'center',gap:'.5rem',borderBottom:'1px solid rgba(255,255,255,.1)'}}>
                <div style={{width:8,height:8,borderRadius:'50%',background:'#22c55e',animation:'lp 2s infinite'}}/>
                <span style={{color:'#fff',fontWeight:800,fontSize:'.88rem',flex:1}}>Canvas Chat</span>
                <span style={{fontSize:'.7rem',color:'rgba(255,255,255,.4)'}}>•••</span>
              </div>
              ...
              <div style={{flex:1,overflowY:'auto',padding:'1rem',display:'flex',flexDirection:'column',gap:'.75rem'}}>
                {[
                  ...
                  {av:'A',bg:'#7c3aed',name:'You',text:'Yes! Amazing quality from IKEA 🛋️',time:'14:22',me:true},
                ].map((m,i)=>(
              ...
              <div style={{padding:'.75rem',borderTop:'1px solid rgba(255,255,255,.1)',display:'flex',gap:'.5rem'}}>
                <input placeholder="Say something..." style={{flex:1,background:'rgba(255,255,255,.1)',border:'1px solid rgba(255,255,255,.15)',borderRadius:10,padding:'.5rem .75rem',color:'#fff',fontSize:'.82rem',outline:'none'}}
                  onFocus={e=>{e.target.style.border='1px solid rgba(124,58,237,.8)'}}
                  onBlur={e=>{e.target.style.border='1px solid rgba(255,255,255,.15)'}}/>
                <button style={{background:'linear-gradient(90deg,#7c3aed,#5b21b6)',border:'none',borderRadius:10,width:38,height:38,color:'#fff',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'.9rem'}}>➤</button>
              </div>
            </div>
